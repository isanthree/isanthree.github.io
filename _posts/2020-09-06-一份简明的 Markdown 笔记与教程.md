...
为部门内知识分享准备的素材，记录了 Markdown 的优点、应用场景和编辑工具，介绍了标准语法与扩展语法，以及一些应用 Markdown 的奇技淫巧。个人使用 Markdown 的经验持续补充中，最新完整版请参见网上的一篇博文：

<https://github.com/mzlogin/markdown-intro>

---

自从 接触到 Markdown 以来，对它的使用就一发而不可收拾。从最开始使用它在 GitHub Pages 里写博客，到用它编辑项目的 README 文件，再到撰写邮件内容等等，这期间也见证了它在各类平台和网站上的普及和被原生支持，可以说，Markdown 如今已经渗透了我在技术和网络活动的方方面面，成为了我撰写文本文档的首选。
...
```
行内式 [博客](https://isanthree.github.io "我的个人博客") 链接，带 title。

行内式 [GitHub](https://github.com/isanthree) 链接。

引用式 [博客][1] 链接。

引用式 [GitHub][2] 链接，带 title。

[1]: https://isanthree.github.io
[2]: https://github.com/isanthree "我的 GitHub 主页"
```
...
```html
<p>行内式 <a href="https://isanthree.github.io" title="我的个人博客">博客</a> 链接，带 title。</p>

<p>行内式 <a href="https://github.com/isanthree">GitHub</a> 链接。</p>

<p>引用式 <a href="https://isanthree.github.io">博客</a> 链接。</p>

<p>引用式 <a href="https://github.com/isanthree" title="我的 GitHub 主页">GitHub</a> 链接，带 title。</p>
```
...
```
![Alt text](https://isanthree.github.io/favicon.ico "favicon")
```
...
```html
<img src="https://isanthree.github.io/favicon.ico" alt="Alt text" title="favicon">
```
...
![task list 1](https://cdn.jsdelivr.net/gh/isanthree/blog-gallery/20210515010103.png)

还可以直接在网页上拖动调整顺序，勾选和取消勾选。

![task list 2](https://cdn.jsdelivr.net/gh/isanthree/blog-gallery/20210515010129.png)
...
![流程图](https://cdn.jsdelivr.net/gh/isanthree/blog-gallery/20210515010205.png)

![时序图](https://cdn.jsdelivr.net/gh/isanthree/blog-gallery/20210515010216.png)

### 插入数学公式

仍然以 TAPD 为例：

![数学公式](https://cdn.jsdelivr.net/gh/isanthree/blog-gallery/20210515010229.png)
...
网上一个维护的工具地址：<https://md.mazhuang.org>
...
另外可以参考我以前的一篇博客 [关于 Markdown 的一些奇技淫巧](https://isanthree.github.io/2017/09/01/markdown-odd-skills/)。
...
欢迎关注我，接收 markdown-intro 最新动态。

<div align="center"><img width="192px" height="192px" src="https://isanthree.github.io/assets/images/qrcode.jpg"/></div>